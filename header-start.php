          ...
          <?php }else{ ?>
            ...
            <ul class="nav navbar-nav visible-xs">
              ...
              <p class="navbar-text text-center">
                <?php echo $Translation['signed as']; ?> <strong><a href="<?php echo PREPEND_PATH; ?>membership_profile.php" class="text-success">welcome<?php echo getLoggedMemberID(); ?></a></strong>
              </p>
            </ul>
          <?php } ?>
        <?php } ?>
